...
<section class="vh-100 gradient-custom">
	<div class="container py-5 h-100">
		<div
			class="row d-flex justify-content-center align-items-center h-800">
					...
					<div class="card-body p-4 text-center">
						...
						<div class="mb-md-2 mt-md-2 pb-1">
							...
							<form action="login" method="post">
								...
								<div class="form-outline form-white mb-4 text-none">
									<label class="form-label text-start w-100 fs-5" for="dataNasc">Data
										de Nascimento</label> <input type="date" id="dataNasc" name="dataNasc"
										class="form-control form-control-lg" required />
								</div>
										...
										<div class="modal-content text-dark">
											...
											<div class="modal-body text-white">
												<p class="text-muted mt-3"
													...
													e tem fins exclusivamente educacionais. As imagens, vídeos,
													trechos de filmes e textos utilizados pertencem aos seus
													respectivos criadores e detentores de direitos autorais.
													Seu uso aqui se dá sob o princípio do uso justo (<em>fair

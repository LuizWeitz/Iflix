          ...
          <div class="card-body p-4 text-center">
            ...
            <div class="mb-md-2 mt-md-2 pb-1">
              ...
              <form action="login" method="post">
                ...
                <div class="form-outline form-white mb-4 text-none">
                  <label class="form-label text-start w-100 fs-5" for="dataNasc">Data de Nascimento</label>
                  <input type="date" id="dataNasc" name="dataNasc" class="form-control form-control-lg" required />
                </div>

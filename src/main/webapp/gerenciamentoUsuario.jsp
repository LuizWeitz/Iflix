        ...
        <div class="col-lg-8">
          <div class="card mb-4" style="background-color: transparent; border: 1px solid #444;">
            <div class="card-body text-center py-5 px-5">
              ...
              <form action="editarUsuario" method="post" enctype="multipart/form-data" class="text-start px-3">
              
                <div class="mb-3 text-start">
                  <label class="form-label fs-6" for="imgPerfil">Nova Foto de Perfil</label>
                  <input class="form-control form-control-sm bg-dark text-white rounded-pill border border-secondary"
                ...
                <div class="d-flex justify-content-center gap-3 mt-4">
                  ...
                  <form action="deleteUsuario" method="get" class="d-inline">
                    <input type="hidden" name="id" value="<%= user.getId() %>"/>
                    <button type="submit" class="btn btn-outline-danger px-4">Deletar</button>
                  </form>
                </div>
